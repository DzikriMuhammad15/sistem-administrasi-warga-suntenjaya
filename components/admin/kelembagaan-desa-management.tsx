      ...
      {(isCreating || editingId) && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {editingId ? "Ubah data kelembagaan desa" : "Tambahkan kelembagaan desa"}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              <Label htmlFor="jabatan">Kelembagaan</Label>
              <Input
                id="jabatan"
            ...
            <div>
              <Label htmlFor="jumlah_menjabat">Jumlah Anggota</Label>
              <Input
                id="jumlah_menjabat"
                type="number"
